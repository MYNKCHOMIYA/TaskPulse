...
engine = create_engine(
    SQLITE_TEST_URL, connect_args={"check_same_thread": False}, poolclass=StaticPool
)
...
@pytest.fixture
def sample_user1():
    return {"username": "minku", "email": "minku@gmail.com", "password": "minku123"}


@pytest.fixture
def sample_user2():
    return {"username": "atul", "email": "atul@gmail.com", "password": "atul123"}
